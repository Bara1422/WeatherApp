...
const ButtonsActualWeather = ({ current }) => {
  ...
  return (
    <div className='flex justify-between sm:gap-2 pt-4 text-sm md:text-base'>
      {currentWeather.map((data, index) => (
        <div
          className='sm:w-1/5 sm:justify-center flex sm:mx-auto flex-col sm:flex-row p-4 text-center text-blue-400 font-semibold bg-gray-100 rounded-full basis-[30%] sm:gap-2  mx-auto items-center'
          key={index}
        >
